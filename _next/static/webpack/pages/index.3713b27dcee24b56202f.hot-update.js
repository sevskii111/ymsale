...
function Home(_ref) {
  ...
  var columns = [{
    ...
    sortFunction: function sortFunction(rowA, rowB) {
      return parseInt(rowA.match(/\d+/)[0]) - parseInt(rowB.match(/\d+/)[0]);
    },
